...
const createIcon = (paths: React.ReactNode, displayName: string) => {
    const Icon = ({ className = "w-6 h-6", ariaLabel, ariaHidden = true }: IconProps) => (
        <svg
            viewBox="0 0 24 24"
            fill="none"
            className={className}
...
export const VisionIcon = createIcon(
    <>
...
export const KeysIcon = createIcon(
...
export const ConnectorsIcon = createIcon(
    <>
...
export const ChromeIcon = ({ className = "w-4 h-4" }: IconProps) => (
